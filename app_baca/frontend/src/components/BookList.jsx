  ...
  return (
    <div className="flex gap-2">
      ...
      <button
        ...
        title={book.sedangDipinjam ? 'Tidak bisa hapus buku yang sedang dipinjam' : 'Hapus buku'}
      >
        Hapus
      </button>
    </div>
...
const PeminjamInfo = ({ book }) => {
  ...
  // Cari peminjaman aktif dari riwayat
  ...
  const tanggalPinjam = new Date(activePeminjaman.tanggalPinjam).toLocaleDateString('id-ID');

  return (
    <div className="text-sm">
      <div className="font-medium text-gray-900">{activePeminjaman.namaPeminjam}</div>
    ...
    <div className="overflow-x-auto bg-white rounded-xl shadow border border-gray-200">
      <table className="w-full text-sm">
        <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
          <tr>
            <th className="px-6 py-4 text-left font-semibold text-gray-900">Judul</th>
            <th className="px-6 py-4 text-left font-semibold text-gray-900">Penulis</th>
            <th className="px-6 py-4 text-left font-semibold text-gray-900">Tahun</th>
            <th className="px-6 py-4 text-left font-semibold text-gray-900">Status</th>
            <th className="px-6 py-4 text-left font-semibold text-gray-900">Peminjam</th>
        ...
        <tbody>
          {books.map((book) => (
            ...
            >
              ...
              <td className="px-6 py-4 text-gray-700">{book.tahun_publish || '-'}</td>
              <td className="px-6 py-4">
